...
public class SocialCheckedTextView extends CheckedTextView {

    private ClickableSpan mPressedSpan;

    public SocialCheckedTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public SocialCheckedTextView(Context context) {
        super(context);
    }
