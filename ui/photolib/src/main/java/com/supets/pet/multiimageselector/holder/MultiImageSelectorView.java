...
public class MultiImageSelectorView extends FrameLayout
    ...
    private int mDesireImageCount = MultiImageConfig.MaxNum;
    private int mode = MultiImageConfig.MODE_SINGLE;
    ...
    public void setData(boolean isShowCamera, int cameraBg,
        ...
        if (mode == MultiImageConfig.MODE_SINGLE) {
        ...
        mImageAdapter.showSelectIndicator(mode == MultiImageConfig.MODE_MULTI);
    ...
    private void selectImageFromGrid(Image image) {
        ...
        // 多选模式
        if (mode == MultiImageConfig.MODE_MULTI) {
        ...
        } else if (mode == MultiImageConfig.MODE_SINGLE) {
            // 单选模式
