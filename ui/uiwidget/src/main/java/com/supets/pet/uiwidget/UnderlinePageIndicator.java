 ...
 */
public class UnderlinePageIndicator extends View implements
    ...
    public UnderlinePageIndicator(Context context, AttributeSet attrs,
        ...
        final int defaultSelectedColor = getResources().getColor(R.color.UnderlinePageIndicator_app_color);
    ...
    public void resetWidth(int tabNums) {
        int height = getResources().getDimensionPixelSize(R.dimen.UnderlinePageIndicator_line_px4);
        int width = getResources().getDisplayMetrics().widthPixels;
        if (tabNums > MAXITEM) {
            width = width / MAXITEM;
            getLayoutParams().width=width * tabNums;
