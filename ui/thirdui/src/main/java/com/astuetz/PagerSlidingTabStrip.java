...
import com.supets.pet.supetsuilibrary.R;
...
public class PagerSlidingTabStrip extends HorizontalScrollView {
	...
	public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
		...
		tabTextSizeSelected = tabTextSize;
	...
	private void updateTabStyles() {
		...
		for (int i = 0; i < tabCount; i++) {
			...
			if (v instanceof TextView) {
				...
				tab.setTextColor(createColorStateList(tabTextColor, tabTextColorSelected));
				...
				//CalligraphyUtils.applyFontToTextView(getContext(), tab, fontPath);
			}
		}
	...
	private void scrollToChild(int position, int offset) {
		...
		if (position > 0 || offset > 0) {
			//int newScrollOffset = (getWidth() - tabsContainer.getChildAt(position).getWidth()) / 2;
			newScrollX -= scrollOffset;
		}

		if (newScrollX != lastScrollX) {
			lastScrollX = newScrollX;
			//System.out.println("position:" + position + ", currentPositionOffset:" + currentPositionOffset + ", newScrollX:" + newScrollX);
	...
	protected void onDraw(Canvas canvas) {
		...
		int bottom = height - indicatorMargin;
	...
	private class PageListener implements OnPageChangeListener {
		...
		public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
			...
			scrollToChild(position, (int) (positionOffset * (child == null ? 0 : child.getWidth())));
	...
	private void updateSelection(int position) {
		...
		for (int i = 0; i < tabsContainer.getChildCount(); i++) {
			...
			if (child instanceof TextView) {
				...
				int sizePx = position == i ? tabTextSizeSelected : tabTextSize;
