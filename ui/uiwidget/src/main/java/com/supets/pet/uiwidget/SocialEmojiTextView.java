 ...
 * 2 先设置文本内容，setText(String),(不需要调用setClickText)然后在设置Span，
...
public class SocialEmojiTextView extends EmojiconTextView {
	...
	public SocialEmojiTextView(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		init(context);
	}

	public SocialEmojiTextView(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context);
	}
