...
public class SnapBottomScrollView extends ScrollView  implements SnapPageLayout.SnapPageContent {
    // 滑动距离及坐标
    private float xDistance, yDistance, xLast, yLast;

    public SnapBottomScrollView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
