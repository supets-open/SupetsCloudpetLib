...
import com.supets.corenetwork.R;
...
public class FrescoUtils {
    ...
    private static ImageRequestBuilder getResizeImageRequest(Uri formUri) {
        return ResizeManager.getResizeImageRequest(formUri);
    }
    ...
    public static void displayImageWithSmallNoRepeat(String uri, SimpleDraweeView view) {
        int width = UIUtils.getScreenWidth() / 3;
        displayImageWithSmall(uri, view, width, width);
    }

    public static void displayImageWithSmallNoRepeat(String uri, SimpleDraweeView view, int
            width, int height) {
