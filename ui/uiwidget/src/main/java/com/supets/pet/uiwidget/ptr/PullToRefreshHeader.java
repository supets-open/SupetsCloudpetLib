...
public class PullToRefreshHeader extends FrameLayout implements PtrUIHandler {
    ...
    public void onUIRefreshPrepare(PtrFrameLayout frame) {
        ...
        if (frame.isPullToRefresh()) {
            mTitleTextView.setText(getResources().getString(R.string.supet_cube_ptr_pull_down_to_refresh));
        } else {
            mTitleTextView.setText(getResources().getString(R.string.supet_cube_ptr_pull_down));
        }
    }
    ...
    public void onUIRefreshBegin(PtrFrameLayout frame) {
        ...
        mTitleTextView.setVisibility(VISIBLE);
        mTitleTextView.setText(R.string.supet_cube_ptr_refreshing);
    ...
    public void onUIRefreshComplete(PtrFrameLayout frame) {
        ...
        mTitleTextView.setVisibility(VISIBLE);
        mTitleTextView.setText(getResources().getString(R.string.supet_cube_ptr_refresh_complete));
...
//                    mRotateView.startAnimation(mFlipAnimation);
    ...
    private void crossRotateLineFromTopUnderTouch(PtrFrameLayout frame) {
        if (!frame.isPullToRefresh()) {
            mTitleTextView.setVisibility(VISIBLE);
            mTitleTextView.setText(R.string.supet_cube_ptr_release_to_refresh);
        }
    }
